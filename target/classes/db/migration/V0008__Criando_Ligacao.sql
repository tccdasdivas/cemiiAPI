...
alter table tb_familia add constraint fk_familia_cidade foreign key (cidade_id) references tb_cidade(id);
...
alter table tb_familia add constraint fk_familia_grauparentesco foreign key (grauparentesco_id) references tb_grauparentesco(id);
alter table tb_familia add constraint fk_familia_idoso foreign key (idoso_id) references tb_idoso(id);